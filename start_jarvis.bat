...
".venv\Scripts\pip.exe" install uvicorn fastapi pydantic psutil wmi pyautogui pyperclip AppOpener telethon requests httpx piper-tts Pillow sounddevice faster-whisper numpy soundcard
